...
const Hero = () => {
  return (
    <div className="absolute left-0 right-0 top-[20%] lg:top-[33%] flex  flex-col items-center justify-center flex-1 text-center">
      ...
      <div className="flex lg:flex-row flex-col gap-4 lg:gap-0 mt-2 lg:mt-4">
        ...
        <button className="flex items-center max-w-sm p-2 mx-auto bg-indigo-600 text-white text-sm lg:text-lg text-center px-4 rounded-sm lg:rounded-none">
          Get Started
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mx-auto lg:w-6 w-4 h-4 lg:h-6">
